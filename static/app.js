...
$(document).ready(function(){
    ...
    $('.image-tag').change(function(event){
        train_data.image = _.get(event, 'target.value', '');
    });
    ...
    $('.tabs li').on('click', function(e){
        ...
        if (active_section == "train-content")
        {
    ...
    $('#train').submit(function(event){
        message = null;
        if(train_data.name && (train_data.file || train_data.image)){
            ...
            train_form_data.append('image', train_data.image);
